...
为便于把握分析对象的规模，先看本次分析范围 `src` 目录的代码体量：
...
为了便于把握节奏，全书被压缩成下面六个连续阶段：

1. 基础准备阶段：先读第 1、2、3、4 章，建立概念框架、术语系统和学习路线。
2. 主链路建立阶段：重点读第 5、6、7、8、9、10、11 章，把一次请求从头到尾走通。
3. 核心能力层阶段：重点读第 12、13、14、15、16、17、18 章，理解命令、工具、任务与扩展体系。
4. 运行支撑层阶段：读第 19、20、21、22 章，理解 UI、状态、权限、压缩、持久化与恢复。
5. 全局回看阶段：读第 23、24、25、26、27 章，把“知道发生了什么”升级为“知道为什么这样设计、为什么应该这样读，以及怎样把知识沉淀下来”。
6. 通关训练阶段：先用第 28 章做整书复盘，再完成第 29、30 章里的训练任务、实验题和自测问题。

若目标是进入修改、扩展或重写层面，不应跳过第 29 章和第 30 章。这两章不是附录，而是把“读懂”转化为“掌握”的关键环节。
...
- 零基础背景可先读第 1、2、3、4 章，再进入主链路章节。
- 已具备 TypeScript、React 与 CLI 基础时，仍建议保持顺读，只是在第 5 章到第 11 章可以适当加快速度，把注意力集中在主链路与流式机制上。
- 若目标是进入修改与重写层面，不应跳过第 25、26、27、28、29、30 章；这些章节负责把“看懂”沉淀为“能复盘、能定位、能修改”。
- 如中途失去全局把握，优先返回第 23 章和第 24 章。前者给出模块地图，后者给出模块交互案例，可用来把零散理解重新织回系统图。

## 阅读路线图

```mermaid
flowchart TD
    A["第 1 章 + 第 2 章<br/>零基础预备知识与术语词典"] --> B["第 3 章 + 第 4 章<br/>学习路线与开学第一课"]
    B --> C["第 5 章<br/>一次请求走完全链路"]
    C --> D["第 6 章 + 第 7 章<br/>架构与启动"]
    D --> E["第 8 章 + 第 9 章 + 第 10 章 + 第 11 章<br/>输入、查询时序与 API 流"]
    E --> F["第 12 章 + 第 13 章 + 第 14 章 + 第 15/16/17/18 章<br/>命令、工具、任务、扩展与三大案例"]
    F --> G["第 19 章 + 第 20 章 + 第 21 章 + 第 22 章<br/>状态、权限、记忆、持久化与恢复"]
    G --> H["第 23 章 + 第 24 章<br/>模块学习地图与交互案例"]
    H --> I["第 25 章 + 第 26 章 + 第 27 章<br/>阅读法、关键代码与知识沉淀"]
    I --> J["第 28 章<br/>总复盘：一张图、一条主线、十二个问题"]
    J --> K["第 29 章 + 第 30 章<br/>通关与综合训练"]
```
...
1. 先复盘第 5 章到第 11 章，重新把一条请求主链路讲顺。
2. 再回看第 12 章到第 18 章，确认命令、工具、任务与扩展能力是怎样建立的。
3. 然后读第 19 章到第 22 章，补齐那些第一次容易忽略的支撑系统。
4. 接着重读第 23 章到第 27 章，把目录地图、交互案例、阅读方法和关键代码重新织成一张网。
5. 最后用第 28 章到第 30 章做总整合、自测和综合实验。
...
首次接触此类工程时，可从 [第 1 章 零基础预备知识](chapters/15-zero-background-primer.md) 开始；[第 3 章 全书总路线与阶段目标](chapters/23-self-study-roadmap.md) 会在前四章之内自然交代整本书的推进节奏。
