...
因此，这一版不再把外部使用场景当成中心，而是把“学生如何从零开始，最后真正掌握它”当成中心来组织内容。全书当前共 30 章、约 9200 行正文，采用“先建地图，再走主线，后做模块精读，最后以训练和考核收束”的结构。
...
同时，这一版已经不再是“部分章节采用学生视角、部分章节仍是旧讲义口吻”的混合状态，而是把全书 30 章统一改造成了固定模板的完整版写法：
