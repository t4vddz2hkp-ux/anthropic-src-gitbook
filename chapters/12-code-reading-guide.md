...
## 先修关系
- 这章可以在读完全书前后反复使用，但至少建议已经读过第 1 章和第 2 章。
- 如果你已经完成第 16 章的一次请求走读，会更容易体会“主线追踪法”的必要性。
- 这章与第 14、22、24、25 章构成方法论闭环：怎么读、怎么沉淀、怎么复盘、怎么考核。
...
## 章末小结
- 本章围绕“四轮阅读法、证据沉淀和主线追踪”重建了一层稳定理解，不让你只记零散函数名或目录名。
- 真正需要沉淀下来的，不只是 `四轮阅读法`、`证据链`、`主线追踪` 这几个词，而是它们在 `四轮阅读模型`、`证据矩阵`、`问题模板` 里的相互位置。
- 如果你后续在 第 13 章、第 14 章和第 24 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
...
5. 如果后续要继续读 第 13 章、第 14 章和第 24 章，本章哪一部分最值得先回看？为什么？
