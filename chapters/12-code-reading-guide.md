...
- 如已完成第 16 章的一次请求走读，会更容易体会“主线追踪法”的必要性。
...
- 如后续在 第 13 章、第 14 章和第 24 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
