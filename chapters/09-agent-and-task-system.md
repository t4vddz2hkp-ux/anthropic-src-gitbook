...
## 先修关系
- 建议先读第 13 章和第 15 章，先熟悉 Tool 协议和任务容器的基本味道。
- 如果第 9 章已经读过，将更容易理解 AgentTool 是从主循环里被派生出来的。
- 本章与第 17 章、第 18 章联系紧密，前者讲扩展接入，后者讲重量级能力对比。
...
- 如后续在 第 17 章、第 24 章和第 18 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
...
5. 如果后续要继续读 第 17 章、第 24 章和第 18 章，本章哪一部分最值得先回看？为什么？
