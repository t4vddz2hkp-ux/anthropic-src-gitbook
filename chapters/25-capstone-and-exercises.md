...
## 先修关系
- 建议至少已经完成第 28 章复盘和第 29 章通关检查。
- 如仍无法稳定回答主链路与核心边界问题，先不要急着做综合题。
- 本章最适合与第 12 和第 27 章一起使用，一个负责方法，一个负责沉淀。
...
- 如后续在 回到第 27 章和第 28 章做循环强化 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
...
5. 如果后续要继续读 回到第 27 章和第 28 章做循环强化，本章哪一部分最值得先回看？为什么？
