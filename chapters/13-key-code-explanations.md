...
## 先修关系
- 宜先读第 6、7、8、9、12 章，这样更容易理解这些片段为何值得精讲。
- 如果第 20 章已经看过，将更容易把精讲片段挂回目录地图。
- 本章可与第 14 章配合阅读：前者提供精读样本，后者将样本进一步转化为稳定输出。
...
- 如后续在 第 14 章和第 22 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
