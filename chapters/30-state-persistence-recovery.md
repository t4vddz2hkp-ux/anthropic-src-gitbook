...
## 先修关系
- 建议先读第 21 章和第 20 章，先建立状态层次与持久化治理的基本框架。
- 如果第 5 章和第 10 章读过，将更容易看出持久化边界落在请求主线的什么位置。
...
- 如后续在 第 28 章和第 30 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
...
5. 如果后续要继续读 第 28 章和第 30 章，本章哪一部分最值得先回看？为什么？
