...
## 先修关系
- 建议先读第 6 章和第 7 章，至少知道 query 与工具执行是主流程。
- 如果第 18 章和第 30 章还没读，本章可以先建立框架，后面再补状态与恢复细节。
- 本章适合与第 27 章对照，因为很多横切能力会在请求时间线里出现。
...
5. 如果后续要继续读 第 18 章、第 27 章和第 30 章，本章哪一部分最值得先回看？为什么？
