...
## 先修关系
- 建议先读第 9 章，至少要知道主循环会产生 `tool_use`。
- 如果第 8 章已经读过，将更容易把工具结果消息和普通消息区分开。
- 本章与第 14 章是配套关系：本章讲 Tool 是什么，第 14 章讲 Tool 怎么跑。
...
- 如后续在 第 15 章、第 17 章和第 14 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
...
5. 如果后续要继续读 第 15 章、第 17 章和第 14 章，本章哪一部分最值得先回看？为什么？
