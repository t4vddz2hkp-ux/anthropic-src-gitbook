...
## 先修关系
- 建议先读第 8 章和第 13 章，先知道输入层会分流到命令，而能力层是工具。
- 如果第 4 章和第 5 章已经读过，将更容易把命令放回用户入口这条线。
- 本章和第 17 章、第 23 章联系紧密，因为插件和技能最终也会影响命令集合。
...
- 如后续在 第 13 章、第 17 章和第 23 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
...
5. 如果后续要继续读 第 13 章、第 17 章和第 23 章，本章哪一部分最值得先回看？为什么？
