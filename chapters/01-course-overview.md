...
| `六阶段学习路线` | 把全书内容按依赖顺序重新排列。 | 它是你后续阅读、复习和回看的总导航。 |

## 本章在整本书中的位置

这一章是读者正式进入源码之前的“开学第一课”。  
第 15 章负责补零基础概念，第 23 章负责给出整本书的学习路线，而这一章负责回答更具体的问题：

1. 我们面对的到底是什么系统？
2. 它为什么比普通项目难读？
3. 读者在第一遍阅读时，应该抓住什么，不该急着抓什么？

如果这一章没有读稳，后面读者很容易陷入“看见一堆文件，但不知道哪些重要”的状态。

## 读者第一次进入本书时最容易出现的三个误区
...
这一章读完后，读者不需要马上去背所有目录名，但必须立住三件事：
