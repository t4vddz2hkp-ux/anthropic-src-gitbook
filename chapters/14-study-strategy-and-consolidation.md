...
- 让你知道自己现在停留在“读过”“会讲”还是“能改”的哪一层。

## 先修关系
- 建议至少已经读到第 13 章，这样你手头已经有足够的主线与模块材料可供复盘。
...
| `复习单元表` | 按主题团块而不是章节线性推进的复习结构。 | 它能帮助你处理大型系统的复杂度。 |
| `掌握阶梯` | 初阶、中阶、高阶三层标准。 | 它能告诉你现在缺的到底是地图、边界还是设计理由。 |
...
## 章末小结
- 本章围绕“复习节奏、输出模板和掌握标准”重建了一层稳定理解，不让你只记零散函数名或目录名。
