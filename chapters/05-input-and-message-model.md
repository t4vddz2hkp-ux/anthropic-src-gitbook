...
## 先修关系
- 建议先读第 1 章，先熟悉 REPL、CLI、流式输出等基本词汇。
- 如已浏览过第 5 章，会更容易把本章内容挂到完整请求主线上。
- 本章和第 9 章是强耦合关系：前者讲消息怎么进系统，后者讲消息怎么在系统里流动。
...
这一章是第二阶段的关键过桥章。
第 7 章解释系统如何启动，第 9 章解释系统如何运行主循环，而这一章解释“用户说的话”到底是怎样变成系统可处理对象的。
...
- 如后续在 第 9 章、第 5 章和第 10 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
...
5. 如果后续要继续读 第 9 章、第 5 章和第 10 章，本章哪一部分最值得先回看？为什么？
