...
## 先修关系
- 建议先读第 16 章和第 6 章，以先建立对整体主链路的感觉。
- 如果第 19 章和第 28 章读过，将更容易看懂时间线中 API 流和工具流的切换。
...
如果第 16 章像一次全景式导览，那么这一章就是把那条链路拆得更细，细到读者可以真正拿着源码逐步对照。
...
- 如后续在 第 19 章、第 28 章和第 30 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
