...
## 先修关系
- 建议先读第 6 章和第 7 章，先知道 UI 壳层在系统总图中的位置。
- 如已读过第 1 章，REPL 和终端渲染的概念门槛会更低。
- 本章适合与第 21 章配合阅读，前者看 UI 状态，后者看全系统状态层次。
...
- 如后续在 第 21 章和第 22 章 中再次迷路，优先回看本章的“先修关系、正文图解、关键数据结构”三部分。
...
5. 如果后续要继续读 第 21 章和第 22 章，本章哪一部分最值得先回看？为什么？
